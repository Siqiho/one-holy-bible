...
const UNSAFE_PUBLIC_DATA = /\/Users\/|\/Volumes\/|file:\/\/|[A-Za-z]:[\\/]|\\\\[^\\]+\\|(?:https?:\/\/)?(?:127(?:\.\d{1,3}){3}|localhost|10(?:\.\d{1,3}){3}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2}|192\.168(?:\.\d{1,3}){2})(?=[:/]|$)|sourceApi(?:Base|Url)?|sourceWorkbenchPath|needs_review/i;
