...
- 复核日期：2026-09-11
- 对照快照：`cursor/ohb-prov-1to1-hold-queue-d28f`（约翰 / 创世记 / 诗篇 / 耶利米 / 路加 / 使徒行传 / 马太 / 以赛亚 / 马可 / 申命记 / 罗马书 / 撒母耳记上 / 出埃及记 / 箴言 / 哥林多前书已审）
- 用户硬要求：OHB 卡片审核除按书卷 1:1 外，必须覆盖全部信息源并核对数量口径
- 应用对照面：`public/data/books/*.json`（公开 v0.1.0，10,239 张文字卡）
...
公开包现计 10,239 = 研修本 9,232 + CMC 858 + OCR 146 + 信息系列 3。没有启导本，没有故事卡。隔离 ∩ 公开 = ∅。撒母耳记上撤下 14 张，出埃及记再撤下 11 张，箴言再撤下 5 张，哥林多前书再撤下 9 张。六源标识口径不变，不改写映射。
...
| 圣经研修本 | 16,270 | 9,232 | 10 | 495（409 已在公开包） | 751（`study-note-*`，另一套本地编码） | **9,328**（只计 `study-bible-*`）；若加 `study-note-*` 则 10,079 | **缺口** |
...
| --- | --- | --- | --- | --- | --- | --- |
| 综合解读 | 156 hold（隔离）+ 609 ledger-only；公开 0 | 858 keep（有解释）；506 hold 撤出公开 | 1,610 hold / ledger-only；公开 0 | 1,006 hold / ledger-only；公开 0 | 144 hold / ledger-only；使徒行传 543 / 马太 143 / 以赛亚 947 / 马可 280 / 申命记 684 / 罗马书 113 / 撒母耳记上 578 / 出埃及记 716 / 箴言 673 / 哥林多前书 241 hold / ledger-only；公开 0 | **是**。有解释才 keep；无解释一律 hold / ledger-only，不抬进公开包 |
| 研修本 | 公开 409 keep/fix；82 宽范围 hold；4 损坏 hold | 272 keep；1 fix | 421 keep/fix；15 hold | 658 keep/fix；14 hold | 531 keep/fix；27 hold；使徒行传 462 keep/fix、21 hold；马太 430 keep/fix、23 hold；以赛亚 454 keep/fix、21 hold；马可 247 keep/fix、13 hold；申命记 233 keep/fix、11 hold；罗马书 214 keep/fix、16 hold；撒母耳记上 259 keep/fix、14 hold；出埃及记 198 keep/fix、11 hold；箴言 194 keep/fix、5 hold；哥林多前书 183 keep/fix、9 hold | **是**。已审卷按 1:1 做 keep/fix/hold；未审卷仍在公开包，等待后续书卷轮 |
...
未审公开研修本仍在包内，它们的 keep/fix/hold 要等后续书卷轮，不在本矩阵里假装已经 1:1 审完。撒母耳记上、出埃及记、箴言与哥林多前书已收束。六源映射口径不变。
