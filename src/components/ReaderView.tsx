...
export function ReaderView({ versions, resources, initialPosition: preferredPosition, onExitReader }: ReaderViewProps) {
  ...
  const goToChapter = useCallback((nextBook: string, nextChapter: number) => {
