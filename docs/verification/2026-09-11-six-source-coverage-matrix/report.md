...
- 复核日期：2026-09-11
- 对照快照：`cursor/ohb-luke-1to1-hold-queue-63b7`（约翰 / 创世记 / 诗篇 / 耶利米 / 路加已审）
...
公开包现计 10,383 = 研修本 9,376 + CMC 858 + OCR 146 + 信息系列 3。没有启导本，没有故事卡。隔离 ∩ 公开 = ∅。
...
| 圣经研修本 | 16,270 | 9,376 | 10 | 495（409 已在公开包） | 751（`study-note-*`，另一套本地编码） | **9,472**（只计 `study-bible-*`）；若加 `study-note-*` 则 10,223 | **缺口** |
...
## 3. 已审五卷的 keep / hold / fix 是否覆盖该类

| 源 | 约翰 | 创世记 | 诗篇 | 耶利米 | 路加 | 本类是否已被策略覆盖 |
| --- | --- | --- | --- | --- | --- | --- |
| 综合解读 | 156 hold（隔离）+ 609 ledger-only；公开 0 | 858 keep（有解释）；506 hold 撤出公开 | 1,610 hold / ledger-only；公开 0 | 1,006 hold / ledger-only；公开 0 | 144 hold / ledger-only；公开 0 | **是**。有解释才 keep；无解释一律 hold / ledger-only，不抬进公开包 |
| 研修本 | 公开 409 keep/fix；82 宽范围 hold；4 损坏 hold | 272 keep；1 fix | 421 keep/fix；15 hold | 658 keep/fix；14 hold | 531 keep/fix；27 hold | **是**。已审卷按 1:1 做 keep/fix/hold；未审卷仍在公开包，等待后续书卷轮 |
...
未审公开研修本仍在包内，它们的 keep/fix/hold 要等后续书卷轮，不在本矩阵里假装已经 1:1 审完。下一卷建议：**使徒行传**（公开研修本 483，隔离 CMC 543，公开 OCR 0）。备选以赛亚（475 / 隔离 947）、马太（453 / 隔离 143）。六源映射口径不变。
