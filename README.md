...
That regeneration command depends on source inputs that are intentionally not distributed in this public repository. Contributors who do not have those inputs should use the checked-in packages and run `npm run validate:public-data`.
