...
- Backups created by Codex must live in a new child directory under `/Users/simon/备份/codex` with a `README.md` describing reason, absolute original paths, and time.
- New or modified documentation filenames must contain ``; standard generated GitHub filenames such as `README.md`, `LICENSE`, `SECURITY.md`, and `PUBLIC_RELEASE.json` are emitted artifacts, not edited source documents.
...
**Files:**
- Create: `/Users/simon/OHB/one-holy-bible/docs/verification/2026-07-15-ohb-independent-public-release-verification.md`
- Modify: `/Users/simon/OHB/one-holy-bible/docs/superpowers/plans/2026-07-15-ohb-independent-public-release.md`
