...
describe("Luke public card audit and isolation hold-queue", () => {
  ...
  it("reconciles the six public source streams without lifting held classes", () => {
    ...
    expect(publicMix).toEqual({ cmc: 858, study: 9109, qidaben: 0, ocr: 146, hurlbut: 0, info: 3, other: 0 });
    expect(publicMix.cmc + publicMix.study + publicMix.ocr + publicMix.info).toBe(10116);
