...
- Standard GitHub files may use required names such as `README.md`, `LICENSE`, `CONTRIBUTING.md`, and `SECURITY.md`; all internal Codex documents must contain `【codex】`.
...
- Backup: `/Users/simon/OHB/one-holy-bible/src/data/generated/workbenchSyncedResources【codex-v4】.json`
...
- Original paths:
  ...
  - /Users/simon/OHB/one-holy-bible/src/data/generated/workbenchSyncedResources【codex-v4】.json
```
...
**Interfaces:**
- Consumes: `src/data/generated/bibleLibrary.json`, `src/data/generated/workbenchSyncedResources【codex-v4】.json`, and `BIBLE_BOOKS` order.
...
```json
"generate:public-data": "node scripts/generatePublicBibleData.mjs --bible src/data/generated/bibleLibrary.json --resources src/data/generated/workbenchSyncedResources【codex-v4】.json --output public/data --release-version 0.1.0",
...
- Create: `docs/verification/2026-07-14-github-text-first-release-verification【codex】.md`
- Create: `docs/releases/2026-07-14-v0.1.0-release-notes【codex】.md`
...
Record commands, pass/fail counts, build size, public-data counts, clean-clone result, manual paths, observability events, remaining limitations, backup path, and exact commit SHA. The filename must contain `【codex】`.

- [ ] **Step 6: Commit the release candidate**

```bash
git add -- .gitignore .github .node-version README.md LICENSE THIRD_PARTY_NOTICES.md CONTRIBUTING.md SECURITY.md DATA_SOURCES.md package.json package-lock.json public/data scripts/generatePublicBibleData.mjs scripts/generatePublicBibleData.test.mjs src src-tauri/Cargo.toml src-tauri/Cargo.lock src-tauri/src src-tauri/tauri.conf.json 'docs/verification/2026-07-14-github-text-first-release-verification【codex】.md' 'docs/releases/2026-07-14-v0.1.0-release-notes【codex】.md'
...
gh release create v0.1.0 --repo Siqiho/one-holy-bible --title "One Holy Bible v0.1.0" --notes-file 'docs/releases/2026-07-14-v0.1.0-release-notes【codex】.md'
```
