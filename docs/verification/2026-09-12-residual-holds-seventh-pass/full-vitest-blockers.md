...
全量 `npm test` 的失败面不读第七轮公开包修补。不补造真源来强行绿全量。GitHub `verify` 上 `validate:public-data` 应绿、全量 `npm test` 仍红，与 PR #32 / #33 / #34 / #35 / #36 同一类缺口。
